...
export const MessageIcon = (icon: IconProps) => {
  return (
...
export const GroupMembersIcon = (icon: IconProps) => {
  return (
    <svg className={icon.className} viewBox='0 0 33 26'  xmlns='http://www.w3.org/2000/svg'>
      <path
        d='M21.9375 5.6875C21.9375 8.82862 19.3911 11.375 16.25 11.375C13.1089 11.375 10.5625 8.82862 10.5625 5.6875C10.5625 2.54638 13.1089 0 16.25 0C19.3911 0 21.9375 2.54638 21.9375 5.6875Z'
      />
      <path
        opacity='0.4'
        d='M28.4375 5.6875C28.4375 7.93115 26.6186 9.75 24.375 9.75C22.1314 9.75 20.3125 7.93115 20.3125 5.6875C20.3125 3.44385 22.1314 1.625 24.375 1.625C26.6186 1.625 28.4375 3.44385 28.4375 5.6875Z'
      />
      <path
        opacity='0.4'
        d='M4.0625 5.6875C4.0625 7.93115 5.88135 9.75 8.125 9.75C10.3687 9.75 12.1875 7.93115 12.1875 5.6875C12.1875 3.44385 10.3687 1.625 8.125 1.625C5.88135 1.625 4.0625 3.44385 4.0625 5.6875Z'
      />
      <path
        d='M26 20.3125C26 23.4536 21.6348 26 16.25 26C10.8652 26 6.5 23.4536 6.5 20.3125C6.5 17.1714 10.8652 14.625 16.25 14.625C21.6348 14.625 26 17.1714 26 20.3125Z'
      />
      <path
        opacity='0.4'
        d='M32.5 20.3125C32.5 22.5561 29.5898 24.375 26 24.375C22.4102 24.375 19.5 22.5561 19.5 20.3125C19.5 18.0689 22.4102 16.25 26 16.25C29.5898 16.25 32.5 18.0689 32.5 20.3125Z'
      />
      <path
        opacity='0.4'
        d='M0 20.3125C0 22.5561 2.91015 24.375 6.5 24.375C10.0899 24.375 13 22.5561 13 20.3125C13 18.0689 10.0899 16.25 6.5 16.25C2.91015 16.25 0 18.0689 0 20.3125Z'
      />
    </svg>
  );
};
