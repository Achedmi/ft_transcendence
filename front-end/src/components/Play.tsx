...
import CloseChat from "../assets/closeChat.svg?react";
const Play = () => {
    ...
    return (
        <div className="h-full w-full flex gap-4">
            <div 
                className={!isChatOpen ? "bg-[#D9D9D9] border-solid border-dark-cl border-[4px] rounded-2xl h-full w-full flex justify-center items-center md:gap-24 gap-7 md:flex-row flex-col relative" 
                ...
                <motion.div
                    className={!isChatOpen ? "red relative aspect-[3/4] w-[40%]  md:w-[35%] max-w-[400px] border-solid border-[4px] border-dark-cl  flex flex-col hover:cursor-pointer"
                ...
                <motion.div 
                    className={!isChatOpen ? "blue relative aspect-[3/4] w-[40%]  md:w-[35%] max-w-[400px] border-solid border-[4px] border-dark-cl  flex flex-col hover:cursor-pointer"
            ...
            {
                isChatOpen && (
                <motion.div className="w-1/2 bg-[#D9D9D9] border-solid border-dark-cl border-[4px] rounded-2xl relative "
                            initial={{ opacity: 0 , scale: 0.5 }}
                            animate={{ opacity: 1 , x: 0 , scale: 1, transition: { type: 'tween'} }}
                            >
                        <motion.div
                            className=" bg-dark-cl h-8  w-8 absolute -top-4 -right-3 hover:cursor-pointer rounded-full flex justify-center items-center hover:bg-red-cl" onClick={() => setIsChatOpen(false)}
                            whileHover={{ scale: 1.2  }}
                            >
