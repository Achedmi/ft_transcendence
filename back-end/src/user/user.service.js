...
var UserService = /** @class */ (function () {
    function UserService(prisma, helpersService, socketGateway) {
        this.prisma = prisma;
    ...
    UserService.prototype.findUnique = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.user.findUnique({ where: data })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    UserService.prototype.findOneByUsername = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.user.findUniqueOrThrow({ where: { id: id } })];
                    case 1:
                        user = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [4 /*yield*/, this.prisma.user["delete"]({ where: { id: user.id } })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, user];
                }
